...
//EASIER TO USE innerHTML property
...
document
  ...
  .setAttribute('src', 'images/robin-sparkles.jpg');
...
//Targeting head to add css link
...
head.querySelector('title').innerHTML = 'AR-Exercise 1';

// console.log(body.innerHTML);
// console.log(body.querySelector('main'));
// body.querySelector('main').innerHTML = 'Hello World';
